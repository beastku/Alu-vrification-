...
#endif
            VL_FATAL_MT("sim/tb_alu.sv", 3, "", "Settle region did not converge.");
        }
...
VL_ATTR_COLD void Vtb_alu___024root___ctor_var_reset(Vtb_alu___024root* vlSelf) {
    ...
    // Body
    vlSelf->tb_alu__DOT__a = VL_RAND_RESET_I(8);
    vlSelf->tb_alu__DOT__b = VL_RAND_RESET_I(8);
    vlSelf->tb_alu__DOT__opcode = VL_RAND_RESET_I(2);
    vlSelf->tb_alu__DOT__result = VL_RAND_RESET_I(8);
    }
